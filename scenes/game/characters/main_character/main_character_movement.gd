...
var gravity = 800 # Gravedad para el personaje
var velocity = 80 # Velocidad de movimiento en horizontal
var jump = 500 # Capacidad de salto, entre mayor el número más se puede saltar
